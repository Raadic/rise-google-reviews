    ...
    <div class="rise-gr-admin-tabs">
        ...
        <div class="tab-content">
            <div id="settings" class="tab-pane active">
                <form method="post" action="options.php">
                    ...
                    <table class="form-table">
                        <tr>
                            <th scope="row">
                                <label for="rise_gr_api_key"><?php esc_html_e('Google Places API Key', 'rise-google-reviews'); ?></label>
                            </th>
                            <td>
                                <input type="text" id="rise_gr_api_key" name="rise_gr_api_key" value="<?php echo esc_attr(get_option('rise_gr_api_key')); ?>" class="regular-text">
                                <p class="description">
                        ...
                        <tr>
                            <th scope="row">
                                <label for="rise_gr_place_id"><?php esc_html_e('Place ID', 'rise-google-reviews'); ?></label>
                            </th>
                            <td>
                                <input type="text" id="rise_gr_place_id" name="rise_gr_place_id" value="<?php echo esc_attr(get_option('rise_gr_place_id')); ?>" class="regular-text">
                                <p class="description">
                        ...
                        <tr>
                            <th scope="row">
                                <label for="rise_gr_cache_time"><?php esc_html_e('Cache Time (hours)', 'rise-google-reviews'); ?></label>
                            </th>
                            <td>
                                <input type="number" id="rise_gr_cache_time" name="rise_gr_cache_time" value="<?php echo esc_attr(get_option('rise_gr_cache_time', 24)); ?>" class="small-text" min="1" max="168">
                                <p class="description">
                    ...
                    <button type="button" class="button" id="rise-gr-clear-cache"><?php esc_html_e('Clear Cache', 'rise-google-reviews'); ?></button>
                </form>
            </div>
            ...
            <div id="shortcodes" class="tab-pane">
                ...
                <div class="rise-gr-shortcode-box">
            ...
            <div id="help" class="tab-pane">
                ...
                <div class="rise-gr-help-section">
                    ...
                    <p>
                        <a href="https://developers.google.com/maps/documentation/places/web-service/get-api-key" target="_blank" class="button"><?php esc_html_e('Google Cloud Console', 'rise-google-reviews'); ?></a>
                    </p>
                </div>
                ...
                <div class="rise-gr-help-section">
                    ...
                    <p>
                        <a href="https://developers.google.com/maps/documentation/places/web-service/place-id" target="_blank" class="button"><?php esc_html_e('Place ID Finder', 'rise-google-reviews'); ?></a>
                    </p>
                </div>
